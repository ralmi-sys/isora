...
import net.isora.vpn.bg.AppChangeReceiver
...
import net.isora.vpn.compose.screen.tools.TaildropFiles
import net.isora.vpn.constant.Bugs
import net.isora.vpn.database.Settings
import net.isora.vpn.utils.AppLifecycleObserver
import net.isora.vpn.utils.HookModuleUpdateNotifier
...
import net.isora.vpn.Application as BoxApplication
