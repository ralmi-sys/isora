package net.isora.vpn.compose.screen.privilegesettings
...
import net.isora.vpn.compose.base.rememberApplyServiceChangeNotifier
import net.isora.vpn.compose.shared.AppSelectionCard
import net.isora.vpn.compose.shared.PackageCache
import net.isora.vpn.compose.shared.SortMode
import net.isora.vpn.compose.shared.buildDisplayPackages
...
import net.isora.vpn.ktx.clipboardText
import net.isora.vpn.utils.PrivilegeSettingsClient
import net.isora.vpn.vendor.PackageQueryManager
import net.isora.vpn.vendor.PrivilegedAccessRequiredException
