package net.isora.vpn.compose.screen.connections
...
import net.isora.vpn.compose.model.ConnectionSort
import net.isora.vpn.compose.model.ConnectionStateFilter
