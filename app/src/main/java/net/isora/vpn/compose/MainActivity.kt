...
import net.isora.vpn.BuildConfig
import net.isora.vpn.R
import net.isora.vpn.bg.BoxService
import net.isora.vpn.bg.CrashReportManager
import net.isora.vpn.bg.OOMReportManager
import net.isora.vpn.bg.PowerReportManager
import net.isora.vpn.bg.ServiceConnection
import net.isora.vpn.bg.ServiceNotification
import net.isora.vpn.compat.WindowSizeClassCompat
import net.isora.vpn.compat.isWidthAtLeastBreakpointCompat
import net.isora.vpn.compose.base.GlobalEventBus
import net.isora.vpn.compose.base.SelectableMessageDialog
import net.isora.vpn.compose.base.UiEvent
import net.isora.vpn.compose.component.RemoteStatusBar
import net.isora.vpn.compose.component.ServiceStatusBar
import net.isora.vpn.compose.component.SnackbarHost
import net.isora.vpn.compose.component.UpdateAvailableDialog
import net.isora.vpn.compose.component.UptimeText
import net.isora.vpn.compose.model.Connection
import net.isora.vpn.compose.navigation.NavHost
import net.isora.vpn.compose.navigation.NewProfileArgs
import net.isora.vpn.compose.navigation.ProfileRoutes
import net.isora.vpn.compose.navigation.Screen
import net.isora.vpn.compose.navigation.bottomNavigationScreens
import net.isora.vpn.compose.screen.configuration.ProfileImportHandler
import net.isora.vpn.compose.screen.connections.ConnectionDetailsScreen
...
import net.isora.vpn.compose.screen.tools.TaildropSendManager
...
import net.isora.vpn.compose.theme.Theme
import net.isora.vpn.compose.topbar.LocalScaffoldPadding
import net.isora.vpn.compose.topbar.LocalTopBarController
import net.isora.vpn.compose.topbar.TopBarController
import net.isora.vpn.compose.topbar.TopBarEntry
import net.isora.vpn.constant.Action
import net.isora.vpn.constant.Alert
import net.isora.vpn.constant.ServiceMode
import net.isora.vpn.constant.Status
import net.isora.vpn.database.Settings
import net.isora.vpn.ktx.hasPermission
import net.isora.vpn.ktx.launchCustomTab
import net.isora.vpn.update.UpdateState
import net.isora.vpn.utils.RemoteControlManager
import net.isora.vpn.vendor.Vendor
    ...
    fun App() {
        ...
        val currentRootRoute =
            when {
                ...
                currentRoute == Screen.Servers.route -> Screen.Servers.route
                currentRoute == Screen.Account.route -> Screen.Account.route
                else -> currentRoute
            }
