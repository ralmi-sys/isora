package net.isora.vpn.compose.screen.usbip
...
import net.isora.vpn.usbip.bcdToVersion
import net.isora.vpn.usbip.formatVidPid
import net.isora.vpn.usbip.usbBackendLabel
import net.isora.vpn.usbip.usbClassTriplet
import net.isora.vpn.usbip.usbSpeedLabel
