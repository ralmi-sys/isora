package net.isora.vpn.xposed.hooks.hidevpnapp
...
import net.isora.vpn.xposed.HookErrorStore
import net.isora.vpn.xposed.PrivilegeSettingsStore
import net.isora.vpn.xposed.VpnAppStore
import net.isora.vpn.xposed.hooks.SafeMethodHook
import net.isora.vpn.xposed.hooks.XHook
