package net.isora.vpn.database

import android.os.Build
import androidx.room.Room
import net.isora.vpn.Application
import net.isora.vpn.BuildConfig
import net.isora.vpn.bg.ProxyService
import net.isora.vpn.bg.VPNService
import net.isora.vpn.constant.Path
import net.isora.vpn.constant.ServiceMode
import net.isora.vpn.constant.SettingsKey
import net.isora.vpn.database.preference.KeyValueDatabase
import net.isora.vpn.database.preference.RoomPreferenceDataStore
import net.isora.vpn.ktx.boolean
import net.isora.vpn.ktx.int
import net.isora.vpn.ktx.long
import net.isora.vpn.ktx.map
import net.isora.vpn.ktx.string
import net.isora.vpn.ktx.stringSet
